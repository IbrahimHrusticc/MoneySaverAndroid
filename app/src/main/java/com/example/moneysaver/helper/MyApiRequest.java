...
import com.example.moneysaver.Login;
                ...
                if (result.isException)
                {
                    if (result.resultCode == 401)
                    {
                        ...
                        if (result.resultCode == 0) {
                            ...
                            alertDialog.setMessage("Došlo je do greške, provjerite internet konekciju ili pokušajte kasnije");
                ...
                else
                {
                    if (myCallback !=null) {
                        ...
                        try {
                            ...
                            View parentLayout = activity.findViewById(android.R.id.content);
                            Snackbar.make(parentLayout, "Došlo je do greške unutar aplikacije!", Snackbar.LENGTH_LONG).show();
                        }
                        //}
                        myCallback.run(x);
                    }
